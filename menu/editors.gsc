...
{        
    ...
    while( curs <= max-1 )
    {
        ...
        progress[progress.size] = self createRectangle("LEFT", "CENTER", progress[progress.size-1].x -107 + (curs / position_x), progress[progress.size-1].y, 12, 12, self.presets["SUBT_BG"], "white", 5, 1); //INNER
